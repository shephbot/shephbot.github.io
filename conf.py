...
BLOG_AUTHOR = "Pushpendre Rastogi"  # (translatable)
BLOG_TITLE = "Shephbot"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://shephbot.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://shephbot.com/"
BLOG_EMAIL = "topdog@shephbot.com"
BLOG_DESCRIPTION = "Coming Soon: Tools for Human productivity"  # (translatable)
